...
const COPY: Record<Locale, Record<string, string>> = {
  es: {
    ...
    missingBody: 'Si querés que armemos una propuesta para tu equipo, escribinos en Lawal.',
  ...
  en: {
    ...
    missingBody: "If you'd like us to put together a proposal for you, get in touch with Lawal.",
