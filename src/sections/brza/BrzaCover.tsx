...
export default function BrzaCover({ c }: { c: BrzaContent['cover'] }) {
  return (
    ...
    >
      ...
      <div className="mt-10 flex items-center gap-4 md:gap-6 text-text-secondary">
        <img
        ...
        />
        <span className="w-px h-6 md:h-7 bg-border-accent" />
        <img
          src={`${import.meta.env.BASE_URL}teo-logo.png`}
          alt="Teo"
