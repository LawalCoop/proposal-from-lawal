...
type Props = {
  c: BrzaContent['proposal']
  pricing: BrzaContent['pricing']
}

const BAR_STYLES = [
  {
    fill: 'linear-gradient(90deg, rgba(196,181,212,0.28) 0%, rgba(196,181,212,0.18) 100%)',
    border: 'rgba(196,181,212,0.35)',
    dot: '#c4b5d4',
  },
  {
    fill: 'linear-gradient(90deg, rgba(168,85,247,0.35) 0%, rgba(168,85,247,0.22) 100%)',
